...
/**
 * http://www.cnblogs.com/wader2011/archive/2011/12/02/2271981.html
...
/**
 * 描述：日期处理常用类
 *http://blog.csdn.net/qq_17555933/article/details/51745374
 * @author tongbiao
 */

public class TimeUtil {
    public  SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
    public  SimpleDateFormat dateFormat2 = new SimpleDateFormat("yyyy-MM");
    public  SimpleDateFormat dateFormatDB = new SimpleDateFormat("yyyyMMdd");// 数据库使用的日期格式
    public  SimpleDateFormat dataTimeFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    public  final String Y_M_D = "yyyy-MM-dd";
    public  final String Y_M_D_HM = "yyyy-MM-dd HH:mm";
    public  final String Y_M_D_HMS = "yyyy-MM-dd HH:mm:ss";
    public  final String YMD = "yyyyMMdd";
    public  final String YMDHM = "yyyyMMddHHmm";
    public  final String YMDHMS = "yyyyMMddHHmmss";
    public  final String ymd = "yyyy/MM/dd";
    public  final String ymd_HM = "yyyy/MM/dd HH:mm";
    public  final String ymd_HMS = "yyyy/MM/dd HH:mm:ss";
     ...
     * @return
     */
    public  String getSubTwoTime(String endTime,String startTime){
...
//    System.out.println(""+days+"天"+hours+"小时"+minutes+"分");
     ...
     * @return
     */
    public  String getSubTwoTimeYY(String endTime,String startTime){
     ...
     * @return
     */
    public  String getSubTwoTime1(String endTime,String startTime){
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
...
//    System.out.println(""+days+"天"+hours+"小时"+minutes+"分");
     ...
     * @return unix 时间
     */
    public  String getUnixTimeStamp(String dateTime){
     ...
     * @return
     */
/*    public  String gerUnixTime2String(String timestampString, String formats){
     ...
     * @return unix 时间
     */
    public  String getCurrentUnixTimeStamp(){
     ...
     */
    private  SimpleDateFormat newLongYMDFormat() {
     ...
     */
    private  SimpleDateFormat newLongYMDHMSFormat() {
     ...
     */
    public  String toLongYMDHMS(String shortYMDHMS) throws ParseException {
     ...
     */
    private  SimpleDateFormat newShortYMDFormat() {
     ...
     */
    private  SimpleDateFormat newShortYMDHMSFormat() {
     ...
     * @throws ParseException
     */
    public  String toLongYMD(String shortYMD) {
        try {
     ...
     * @return
     */
    public  String convertClientDateToDbDate(String dateStr) {
     ...
     * @return
     */
    public  String getDateStrFormat2(String dateStr) {
        try {
     ...
     * @return
     */
    public  String getDateStrFormatyyyyMMdd(String dateStr) {
        try {
            Date date = dateFormat.parse(dateStr);
     ...
     * @return
     */
    public  int calcDay(String startDate, String endDate) {
        int days = 1;
        try {
     ...
     * @return
     */
    public  Date diffDate(Date date, int day) {
        Calendar c = Calendar.getInstance();
        c.setTimeInMillis(getMillis(date) - ((long) day) * 24 * 3600 * 1000);
        return c.getTime();
    }
     ...
     * @return
     */
    public  Date getDateByMinuteAdd(Date date, int minute) {
     ...
     * @return 返回相减后的日期
     */
    public  int diffDate(Date startDate, Date endDate) {
   ...
   /* public  String format(Date date, String format) {
     ...
     * @return
     */
   /* public  Date format(String dateStr, String format) {
...
*/
     ...
     * @return
     */
/*    public  String format(String dateStr, String format, String toFormat) {
...
//   cal.setTime(new Date(System.currentTimeMillis()));
     ...
     * @return
     */
    public  int getSecond2(Date date) {
        if (date == null) {
            date = new Date();
        }
        Calendar c = Calendar.getInstance();
    ...
    /** 获得给定日期当月的天数 */
    public  int getDays(Calendar cal) {
    ...
    /** 获得给定日期字符串对应的年 */
    public  int getYear(String date_str, String type) {
        return (convertStrToCal(date_str, type).get(Calendar.YEAR));
    }

    /** 日期转日历* */
    public  Calendar convertDateToCal(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        return cal;
    }
    ...
    /** 字符转换日历(动态格式转换) */
    public  Calendar convertStrToCal(String date_str, String type) {
        Calendar cal = Calendar.getInstance();
    ...
    /** 字符转换日期(动态格式转换) */
    public  Date convertStrToDate(String date_str, String type) {
     ...
     */
    private  SimpleDateFormat newShortYMFormat() {
     ...
     * @throws ParseException
     */
    public  String getShortYMDiffMonth(String month, int diffMonth) {
     ...
     * @throws ParseException
     */
    public  String getShortYMDDiffDay(String shortYMD, int diffDay) {
     ...
     * @return
     */
    public  String getAddDay(int diffDay) {
     ...
     * @throws Exception
     */
    public  String getEndDayOfMonth(String shortYM) {
        String month = "";
        try {
    ...
    public  List getShortYMDList(String startShortYMD, String endShortYMD) throws ParseException {
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public  List getShortYMList(String startShortYM, String endShortYM) throws ParseException {
     ...
     * @return
     */
    public  boolean checkExpDate(String expDate) {
     ...
     * @throws Exception
     */
    public  int compareEndAndStart(String start, String end) throws Exception {
        long s = 0;
        if (8 == start.length()) {
     ...
     * @return
     */
   /* public  Date smartFormat(String text) {
        Date date = null;
        try {
     ...
     * @return
     */
    /*public  Date formatStringToDate(String argDateStr, String argFormat) throws Exception {
...
//      }
     ...
     * @return
     */
    public  int getEarlyMidLate(Date date) {
        int day=getDay(date);
        int earlyMidLate=0;
        if(1<=day && day<= 10){
            earlyMidLate=1;
     ...
     * @return
     */
    public  int dateToJulian(Date date){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @return
     */
    public  Date JulianToDate(int date){
     ...
     * @return
     */
    public  Date currentMonthLastDay(){
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.MONTH, 0);
        calendar.set(Calendar.DAY_OF_MONTH, calendar.getActualMaximum(Calendar.DAY_OF_MONTH));
        return calendar.getTime();
    }
    public  int statisSubDay(Date endDate,Date startDate){
     ...
     * @return
     */
    public  String getSubTwoDate(String strDate,int a){
        try{
     ...
     * @return
     */
    public  boolean getCurrentDate(String strDate,Date date) {
    ...
    public  Date addDate1(Date d,long day) throws ParseException {
