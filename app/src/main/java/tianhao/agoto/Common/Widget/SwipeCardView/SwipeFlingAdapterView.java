package tianhao.agoto.Common.Widget.SwipeCardView;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private  final float SCALE_STEP = 0.08f; // view叠加缩放的步长
    //缩放层叠效果
     ...
     *
     * @param context The activity context which extends onFlingListener,  or both
