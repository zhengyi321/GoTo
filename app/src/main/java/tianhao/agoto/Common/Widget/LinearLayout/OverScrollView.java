 ...
 * {@link android.widget.FrameLayout}, meaning you should place one child in it containing the
...
public class OverScrollView extends FrameLayout implements OnTouchListener {
     ...
     final int ANIMATED_SCROLL_GAP = 250;

     final float MAX_SCROLL_FACTOR = 0.5f;
     final float OVERSHOOT_TENSION = 0.75f;
