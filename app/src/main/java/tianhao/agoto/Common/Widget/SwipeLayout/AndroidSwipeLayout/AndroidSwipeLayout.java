package tianhao.agoto.Common.Widget.SwipeLayout.AndroidSwipeLayout;
...
*
*/
public class AndroidSwipeLayout extends FrameLayout {
    @Deprecated
    ...
    public AndroidSwipeLayout(Context context) {
        this(context, null);
    }

    public AndroidSwipeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AndroidSwipeLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface SwipeListener {
        void onStartOpen(AndroidSwipeLayout layout);

        void onOpen(AndroidSwipeLayout layout);

        void onStartClose(AndroidSwipeLayout layout);

        void onClose(AndroidSwipeLayout layout);

        void onUpdate(AndroidSwipeLayout layout, int leftOffset, int topOffset);

        void onHandRelease(AndroidSwipeLayout layout, float xvel, float yvel);
    }
    ...
    public interface SwipeDenier {
         ...
         * gestures As a child of AndroidSwipeLayout
         *
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                l.onHandRelease(AndroidSwipeLayout.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(AndroidSwipeLayout.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(AndroidSwipeLayout.this);
                }
                mEventCounter = 0;
            }
            ...
            if (status == Status.Open) {
                ...
                for (SwipeListener l : mSwipeListeners) {
                    l.onOpen(AndroidSwipeLayout.this);
                }
                mEventCounter = 0;
            }
        }
    ...
    public interface OnLayout {
        void onLayout(AndroidSwipeLayout v);
    }
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!beforeCheck && mIsBeingDragged) {
                    ...
                    //useful when AndroidSwipeLayout wrap a AndroidSwipeLayout or other gestural layout
                    return false;
                }
                break;
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(AndroidSwipeLayout.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, AndroidSwipeLayout.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, AndroidSwipeLayout.this, p, vId);
                }
                if (handled) {
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(AndroidSwipeLayout.this, target == surface);
            }
            return true;
        }
    }
    ...
    public interface DoubleClickListener {
        void onDoubleClick(AndroidSwipeLayout layout, boolean surface);
    }
