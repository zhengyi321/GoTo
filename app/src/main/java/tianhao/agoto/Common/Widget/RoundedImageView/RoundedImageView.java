package tianhao.agoto.Common.Widget.RoundedImageView;
...
public class RoundedImageView extends ImageView {
    ...
    private  final int TILE_MODE_UNDEFINED = -2;
    private  final int TILE_MODE_CLAMP = 0;
    private  final int TILE_MODE_REPEAT = 1;
    private  final int TILE_MODE_MIRROR = 2;

    public  final String TAG = "RoundedImageView";
    public  final float DEFAULT_RADIUS = 0f;
    public  final float DEFAULT_BORDER_WIDTH = 0f;
    public  final Shader.TileMode DEFAULT_TILE_MODE = Shader.TileMode.CLAMP;
    private  final ScaleType[] SCALE_TYPES = {
            ScaleType.MATRIX,
            ScaleType.FIT_XY,
            ScaleType.FIT_START,
    ...
    private RoundedDrawable roundedDrawable = new RoundedDrawable();
    ...
    private  Shader.TileMode parseTileMode(int tileMode) {
        switch (tileMode) {
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        if(mDrawable == null){
            Toast.makeText(getContext(),"mDrawable is null",Toast.LENGTH_LONG).show();
        }
        updateDrawableAttrs();
