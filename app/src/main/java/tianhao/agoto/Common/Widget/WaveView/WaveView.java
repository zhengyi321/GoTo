package tianhao.agoto.Common.Widget.WaveView;
...
/*
 *波浪线动画
 * create by zhyan 20170216
 * from https://github.com/gelitenight/WaveView
 *
 */
...
/*
    public  final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#28FFFFFF");
    public  final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3CFFFFFF");*/
    public  final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#27283c");
    public  final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#32354c");
    /*public  final ShapeType DEFAULT_WAVE_SHAPE = ShapeType.SQUARE;*/
    ...
    private void createShader() {
        ...
        final int wave2Shift = (int) (mDefaultWaveLength );
        for (int beginX = 0; beginX < endX; beginX++) {
