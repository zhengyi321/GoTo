package tianhao.agoto.Common.Widget.ViewPager;

/**
 *
 * http://blog.csdn.net/freesonhp/article/details/9100975
...
public class MyViewPager extends ViewPager {
    ...
    private  final float RATIO = 0.5f;//摩擦系数
    private  final float SCROLL_WIDTH = 30f;
