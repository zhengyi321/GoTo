...
public class RoundedDrawable extends Drawable {
    ...
    public   String TAG = "RoundedDrawable";
    public   int DEFAULT_BORDER_COLOR = Color.BLACK;
    ...
    private  RectF mSquareCornersRect = new RectF();
    ...
    public  RoundedDrawable fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
    ...
    public  Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
    ...
    private  boolean only(int index, boolean[] booleans) {
    ...
    private  boolean all(boolean[] booleans) {
        for (boolean b : booleans) {
            if (b) { return false; }
        }
        return true;
