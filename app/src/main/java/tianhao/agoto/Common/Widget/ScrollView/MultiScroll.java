...
public class MultiScroll extends ScrollView {
    ...
    private  final int ANIMATION_SCREEN_SET_DURATION_MILLIS = 500;
    // What fraction (1/x) of the screen the user must swipe to indicate a page change  
    private  final int FRACTION_OF_SCREEN_WIDTH_FOR_SWIPE = 4;
     ...
     */
    private  final int SNAP_VELOCITY_DIP_PER_SECOND = 600;
    // Argument to getVelocity for units to give pixels per second (1 = pixels per millisecond).  
    private  final int VELOCITY_UNIT_PIXELS_PER_SECOND = 1000;
